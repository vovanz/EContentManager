...
class ContentController extends CController {
	...
	public function actionProjectsList() {
		...
		$projects = new CActiveDataProvider('Project', array('criteria' => $criteria, 'pagination' => array('pageSize' => 20, ), ));
	...
	public function actionProject() {
		...
		$this -> render('project', array('model' => $model, 'components' => $components, 'pname' => $project -> pname, 'pid' => $project -> pid, 'project_model' => $project));
	}
	...
	public function actionEditComponent() {
		...
		$this -> render('edit' . $ctype, array('model' => $model, 'pid' => $pid, 'pname' => $project -> pname, 'type_config' => $model -> type_config));
	}
	...
	public function actionUpload() {
		...
		$folder = Yii::app() -> basePath . '/..' . Yii::app() -> controller -> module -> files_path;
